...
class Model extends EventEmitter {
   ...
   * @param  {Object} [cfg.docVirtuals] Virtual fields to add to `Document` instances.
   * @param  {Object} [cfg.docMethods] Methods to add to `Document` instances.
   * @param  {Object} [cfg.modelMethods] Methods to add to this instance.
   */
  ...
  _wrapRawDoc (doc) {
    if (doc) {
      ...
      _.each(_.get(this._cfg, 'docMethods', {}), (method, key) => {
        doc[key] = Genomatic.bind(method, doc);
      });
